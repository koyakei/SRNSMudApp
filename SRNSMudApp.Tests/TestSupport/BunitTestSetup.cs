...
public static class BunitTestSetup
{
    ...
    public static IServiceCollection AddSrnsComponentServices(this IServiceCollection services)
    {
        ...
        return services
            ...
            .AddScoped<ITagSearchQueryService, TagSearchQueryService>()
            .AddScoped<ITagCommandService, TagCommandService>()
    ...
    public static IServiceCollection AddMockSrnsServices(this IServiceCollection services)
    {
        ...
        return services
            ...
            .AddScoped(_ => new Mock<ITagContentProposalService>().Object)
            .AddScoped(_ => new Mock<ITagNameProposalService>().Object)
            ...
            .AddScoped(_ => new Mock<ITagSearchQueryService>().Object)
            .AddScoped(_ => new Mock<ITagCommandService>().Object)
