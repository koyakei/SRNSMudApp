...
public record TagMovePayload(int? NewParentTagId, string? RequesterMessage = null);
public record EmptyPayload();

[SuppressMessage("Performance", "CA1815:Override equals and operator equals on value types", Justification = "Union type handled by C# compiler")]
public readonly union ContractPayload(
    GratisPayload, MutualPayload, PublicOfferPayload, BountyPayload, TagMovePayload, EmptyPayload);